...
open PTR.Context.Type.RWS.RWS.Compose.Monad
...
module Combine =
    ...
    module Append =
        ...
        type RWSBuilder with

            member inline Delay : f: (unit -> ^a) -> ^a
            member inline Run : f: ^f -> ^f

            member inline Combine : RWS< ^e, ^s, ^w, ^a> * RWS< ^e, ^s, ^w, ^a> -> RWS< ^e, ^s, ^w, ^a>
    ...
    module AsList =
        ...
        type RWSBuilder with
            ...
            member inline Combine : RWS< ^e, ^s, ^w, ^a> * RWS< ^e, ^s, ^w, ^a> -> RWS< ^e, ^s, ^w, ^a list>
                when ^w : (static member Append: ^w -> ^w -> ^w)

            member inline Combine : RWS< ^e, ^s, ^w, ^a> * RWS< ^e, ^s, ^w, ^a list> -> RWS< ^e, ^s, ^w, ^a list>
                when ^w : (static member Append: ^w -> ^w -> ^w)