...
// Minimal
    ...
    val inline local: localization: (^e -> ^e) -> rws: RWS< ^e, ^s, ^w, ^a> -> RWS< ^e, ^s, ^w, ^a>
    ...
    val inline listens: f: (^w -> ^b) -> rws: RWS< ^e, ^s, ^w, ^a> -> RWS< ^e, ^s, ^w, struct(^b * ^a)>

    /// <summary>Return the accumulated value.</summary>
    val read: rws: RWS<'e, 's, 'w, 'a> -> RWS< ^e, ^s, ^w, ^w>
