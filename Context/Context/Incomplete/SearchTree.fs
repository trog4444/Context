namespace PTR.Context.Type//.Incomplete.SearchTree


/////
//[<Struct; NoComparison; NoEquality>]
//(* purpose of function AND lazy seq is so that values are always recomputed, rather than cached
//   Based on a Haskell thing.
//   BUT -- as long as I dont cache (or allow caching) the func may not be necessary???
//*)

//type SearchTree<'T> = Leaf of Value: ^T | Nodes of (unit -> SearchTree< ^T>) seq
