namespace PTR.Context.Type//.Incomplete.Stream
...
//            type StreamBuilder () =
//                member inline _.Bind((m: ^a Stream), (k: ^a -> ^b Stream)) : ^b Stream = Cont.Compose.Monad.bind k m
//                member inline _.Return x = singleton x
//                member inline _.ReturnFrom m : Stream< ^a> = m
