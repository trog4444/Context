...
type Maybe<'T> = Nothing | Just of 'T with
    ...
    static member inline Wrap : x: ^a -> Maybe< ^a>

    static member inline Bind : m: Maybe< ^a> * k: (^a -> Maybe< ^b>) -> Maybe< ^b>
        
    static member inline Map2 : fa: Maybe< ^a> * fb: Maybe< ^b> * f: (^a -> ^b -> ^c) -> Maybe< ^c>

    static member inline Map : fa: Maybe< ^a> * f: (^a -> ^b) -> Maybe< ^b>
        
    static member inline OrElse : c1: Maybe< ^a> * c2: Maybe< ^a> -> Maybe< ^a>

    static member inline Append : Maybe< ^a> * Maybe< ^a> -> Maybe< ^a>
...
module Maybe =
    ...
    val inline defaultWith: def: (unit -> ^a) -> Maybe< ^a> -> ^a
    ...
    module Convert =
        ...
        /// <summary>Test for equality between a given value and its 'Maybe'-equivalent. Returns false if the Maybe is Nothing.</summary>
        [<CompiledName("ToEq")>]
        val inline toEq : a: ^a -> maybe: Maybe< ^a> -> bool when ^a : equality

        /// <summary>Test for comparison between a given value and its 'Maybe'-equivalent. Returns 1 if the Maybe is Nothing.</summary>
        [<CompiledName("ToCompare")>]
        val inline toComp : a: ^a -> maybe: Maybe< ^a> -> int when ^a : comparison
    ...
    module Compose =
        ...
        module Monad =
            ...
            /// <summary>Monadic computation builder specialised to the given monad.</summary>            [<Sealed>]
            type MaybeBuilder =
            ...
            module Plus =
                ...
                module General =
                    ...
                    val mpartitionChoice: m: Maybe<Choice<'a, 'b>> -> Maybe< ^a> * Maybe< ^b>
        ...
        module Applicative =
            ...
            /// <exception cref="System.ArgumentNullException">Thrown when the input sequence is null.</exception>
            [<CompiledName("ForA")>]
            val inline forA: f: (^a -> Maybe< ^b>) -> source: #seq< ^a> -> Maybe< ^b seq>
            ...
            val inline zipWithA: f: (^a -> ^b -> Maybe< ^c>) -> source1: #seq< ^a> -> source2: #seq< ^b> -> Maybe< ^c seq>
