namespace PTR.Context.Type//.Incomplete.DList
...
//                member inline _.ReturnFrom m : DList< ^a> = m
...
//            /// <exception cref="System.ArgumentNullException">Thrown when the input sequence is null.</exception>
//            let inline zipWithA f (source1: #seq< ^a>) (source2: #seq< ^b>) : DList< ^c list> =
